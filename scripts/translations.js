...
const translations = {
    en: {
        // Page title
        "page_title": "Dowran Rowshenow - Portfolio",
        ...
        "contact-text": "I'm always interested in hearing about new opportunities and exciting projects. Feel free to reach out if you'd like to connect!",

        // Footer
        "footer-copyright": "©2025 Dowran Rowshenow. All rights reserved."
    },
    ...
    ru: {
        ...
        // About Section
        "about-title": "Обо мне",
        "about-text-1": "Я страстный разработчик с опытом в современных веб-технологиях. Люблю создавать приложения, которые решают реальные проблемы и обеспечивают исключительный пользовательский опыт.",
        "about-text-2": "Имея прочную основу как во фронтенд, так и в бэкенд разработке, я наслаждаюсь работой над полнофункциональными проектами и изучением новых технологий.",
        "skills-title": "Навыки",
